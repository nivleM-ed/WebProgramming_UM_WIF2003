...
<body>
   ...
   <header id="header">
        ...
        <!-- <a href="index.html" class="logo"><i class="far fa-map"></i>
 ...
 <section id="banner">
        ...
        <div class="inner flex flex-3">
            <div class="align-left">
                    ...
                    <h1 style="margin-top:-60px;text-shadow: 4px 4px 10px #222;"><bold>PlanIt your </br>next Journey</bold></h1>
                    <h5 style="margin-top:-20px;color:#fff;text-shadow: 2px 2px 8px #222;"><bold>Create a fully customized day-by-day itinerary for free</bold></h5>
                                ...
                                <form>
                                  <div class="form-row" style=" ">
                                      ...
                                      <div class="col-auto">
                                            <button type="submit" class="btn btn-default" style="margin-left:600px; margin-top:-115px; position:left;"><i class="fa fa-search"></i></button>
                                            </div>
                </form>
...
<div class="inner">
    <h2>Contact Us</h2>
    <ul class="actions">
        <li><span class="icon fa-phone"></span> <a href="#">1300-88-2222</a></li>
        <li><span class="icon fa-envelope"></span> <a href="#">information@planIt.com</a></li>
        <li><span class="icon fa-map-marker"> </span>64, Hogwart Street, Neverland</li>
    </ul>
</div>
<div class="copyright">
